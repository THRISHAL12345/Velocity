...
async def mock_memory_lookup(operation: str, **kwargs) -> dict:
...
async def mock_calc_engine(operation: str, **kwargs) -> dict:
...
async def mock_state_write(operation: str, **kwargs) -> dict:
...
def mock_memory_lookup_sync(operation: str, **kwargs) -> str:
    """Sync wrapper for mock_memory_lookup."""
    result = asyncio.get_event_loop().run_until_complete(mock_memory_lookup(operation, **kwargs))
    return json.dumps(result)


def mock_calc_engine_sync(operation: str, **kwargs) -> str:
    """Sync wrapper for mock_calc_engine."""
    result = asyncio.get_event_loop().run_until_complete(mock_calc_engine(operation, **kwargs))
    return json.dumps(result)


def mock_state_write_sync(operation: str, **kwargs) -> str:
    """Sync wrapper for mock_state_write."""
    result = asyncio.get_event_loop().run_until_complete(mock_state_write(operation, **kwargs))
    return json.dumps(result)
